	...
	:nhPrivate("~")
{
	...
	nhPrivate.param("ini_x", ini_x, 0.0);
	std::cout << "ini_x = " << ini_x << std::endl;
	nhPrivate.param("ini_y", ini_y, 0.0);
	std::cout << "ini_y = " << ini_y << std::endl;
	nhPrivate.param("ini_z", ini_z, 0.0);
	std::cout << "ini_z = " << ini_z << std::endl;
	nhPrivate.param("ini_roll", ini_roll, 0.0);
	std::cout << "ini_roll = " << ini_roll << std::endl;
	nhPrivate.param("ini_pitch", ini_pitch, 0.0);
	std::cout << "ini_pitch = " << ini_pitch << std::endl;
	nhPrivate.param("ini_yaw", ini_yaw, 0.0);
	std::cout << "ini_yaw = " << ini_yaw << std::endl;
